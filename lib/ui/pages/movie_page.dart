  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        //NOW PLAYING
        Container(
          margin: EdgeInsets.fromLTRB(defaultMargin, 16, defaultMargin, 12),
          child: Text(
            'Now Playing',
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: List.generate(
                      ...
                      (index) =>
                          BrowseButton(userState.user.selectedGenre[index])),
                ),
              );
            } else {
              return SpinKitFadingCircle(color: mainColor, size: 50);
                  ...
                  itemBuilder: (_, index) => Container(
                      margin: EdgeInsets.only(
                          ...
                          right: (index == movies.length - 1)
                              ? defaultMargin
                              : 16),
                      child: CoomingSoonCard(movies[index])));
            } else {
              return SpinKitFadingCircle(color: mainColor, size: 50);
            }
          }),
        ...
        Column(
          children: dummyPromos
              .map((e) => Padding(
                  padding:
                      EdgeInsets.fromLTRB(defaultMargin, 0, defaultMargin, 12),
                  child: PromoCard(e)))
              .toList(),
        ),
        SizedBox(
